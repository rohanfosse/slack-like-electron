...
.qs-empty { text-align: center; color: var(--text-muted, #888); font-size: 14px; padding: 32px 0; }
...
.qs-value { font-size: 28px; font-weight: 700; color: var(--text-primary, #fff); line-height: 1; }
.qs-label { font-size: 12px; font-weight: 600; color: var(--text-muted, #888); text-transform: uppercase; letter-spacing: .5px; }
.qs-section {
...
.qs-section-title { display: flex; align-items: center; gap: 6px; font-size: 13px; font-weight: 700; color: var(--text-primary, #fff); margin: 0; }
...
.qs-bar-count { width: 32px; flex-shrink: 0; font-size: 12px; font-weight: 600; color: var(--text-primary, #fff); }
...
.qs-trend-label { font-size: 9px; color: var(--text-muted, #888); white-space: nowrap; }
</style>
